...
const dict = {
  zh: {
    ...
    // Settings
    settingsSearch: "搜索设置...",
    settingsAiCompletion: "AI 续写",
    settingsAppearance: "外观",
    settingsLanguage: "语言",
    settingsLanguageDesc: "设置界面的显示语言",
    autoCompletionTitle: "自动续写",
    enableCompletion: "启用 AI 续写",
    enableCompletionDesc: "停止输入 0.8 秒后生成建议，按 Tab 接受",
    modelService: "模型服务",
    apiFormat: "API 格式",
  ...
  en: {
    ...
    settingsAiCompletion: "AI Completion",
    settingsAppearance: "Appearance",
    settingsLanguage: "Language",
    settingsLanguageDesc: "Display language for the interface",
    autoCompletionTitle: "Auto-completion",
    enableCompletion: "Enable AI completion",
    enableCompletionDesc: "Suggestions appear 0.8s after you stop typing. Press Tab to accept.",
